...
DATA_DIR = "data/toronto_927_2025_Jan_Jun"

train_path = os.path.join(DATA_DIR, "trip_info_9_section_ver2_simplify_ultra_no_variance_2024_Jul_Dec.csv")
test_path = os.path.join(DATA_DIR, "trip_info_9_section_ver2_simplify_ultra_no_variance_2025_Jan_Jun.csv")
